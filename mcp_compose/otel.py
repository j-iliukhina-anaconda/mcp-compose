...
def setup_otel(
    ...
    *,
    ...
    if not OTEL_AVAILABLE:
        raise ImportError(
            "OpenTelemetry is required for tracing. Install it with: pip install mcp-compose[otel]"
        )
...
def get_tracer(name: str = "mcp-compose") -> Any | None:
    """
...
def get_meter(name: str = "mcp-compose") -> Any | None:
    """
...
_metrics: MCPComposeMetrics | None = None
...
def instrument_mcp_compose(
    ...
    *,
    ...
    if logfire_instance is not None:
        ...
        if hasattr(logfire_instance, "config") and hasattr(
            logfire_instance.config, "get_tracer_provider"
        ):
            tracer_provider = logfire_instance.config.get_tracer_provider()
        if hasattr(logfire_instance, "config") and hasattr(
            logfire_instance.config, "get_meter_provider"
        ):
            ...
            try:
                ...
                if response:
                    if "error" in response:
                        ...
                        if _metrics is not None:
                            _metrics.jsonrpc_errors_total.add(
                                1,
                                {
                                    "method": method,
                ...
                if _metrics is not None:
                    _metrics.jsonrpc_errors_total.add(
                        1, {"method": method, "error_code": "exception"}
                    )
                    if method == "tools/call":
                        tool_name = request.get("params", {}).get("name", "unknown")
                        _metrics.tool_call_errors.add(1, {"tool": tool_name})
...
def _instrument_composer(tracer: Any) -> None:
    ...
    if hasattr(MCPServerComposer, "compose_from_pyproject"):
        _original_methods["MCPServerComposer.compose_from_pyproject"] = (
            MCPServerComposer.compose_from_pyproject
        )
    ...
    if hasattr(MCPServerComposer, "compose_from_discovery"):
        _original_methods["MCPServerComposer.compose_from_discovery"] = (
            MCPServerComposer.compose_from_discovery
        )
    ...
    if hasattr(MCPServerComposer, "invoke_tool"):
        ...
        async def traced_invoke_tool(
            self: Any, tool_id: str, arguments: dict, *args: Any, **kwargs: Any
        ) -> Any:
            start_time = time.time()
...
def _instrument_process(tracer: Any) -> None:
    ...
    if hasattr(Process, "start"):
        ...
        async def traced_start(self: Any) -> None:
            ...
            with tracer.start_as_current_span(
                ...
                span.set_attribute(
                    "mcp.process.command", " ".join(self.command) if self.command else ""
                )
                ...
                try:
                    ...
                    span.set_attribute(
                        "mcp.process.state",
                        str(self.state.value) if hasattr(self.state, "value") else str(self.state),
                    )
                    span.set_attribute("mcp.duration_seconds", time.time() - start_time)
        ...
        async def traced_stop(self: Any, timeout: float = 5.0) -> None:
            with tracer.start_as_current_span(
                ...
                try:
                    ...
                    span.set_attribute(
                        "mcp.process.exit_code",
                        self._exit_code if hasattr(self, "_exit_code") else -1,
                    )
    ...
    if hasattr(Process, "read_message"):
        ...
        async def traced_read_message(self: Any, timeout: float | None = None) -> dict | None:
            with tracer.start_as_current_span(
                "mcp.process.receive",
                ...
                try:
                    ...
                    if message is not None:
                        ...
                        if "error" in message:
                            ...
                            span.set_attribute(
                                "rpc.jsonrpc.error_message", error.get("message", "")[:500]
                            )
            ...
            async def traced_connect(self: Any) -> None:
                ...
                with tracer.start_as_current_span(
                    ...
                    try:
                        ...
                        if _metrics is not None:
                            _metrics.http_requests_total.add(
                                1,
                                {
                                    "method": "CONNECT",
            ...
            async def traced_send(self: Any, message: dict) -> None:
                ...
                with tracer.start_as_current_span(
                    ...
                    try:
                        ...
                        if _metrics is not None:
                            _metrics.http_requests_total.add(
                                1, {"method": "POST", "transport": "http_stream"}
                            )
                            _metrics.http_request_duration.record(
                                duration, {"method": "POST", "transport": "http_stream"}
                            )
...
def _instrument_fastmcp(tracer: Any, capture_config: dict) -> None:
                        ...
                        if capture_results and result is not None:
                            try:
                                ...
                                if isinstance(result, list):
                                    ...
                                    span.set_attribute(
                                        "mcp.tool.result_preview", str(result_preview)
                                    )
                                else:
        ...
        if hasattr(LowLevelServer, "run"):
            ...
            async def traced_run(
                ...
                with tracer.start_as_current_span(
                    ...
                    span.set_attribute(
                        "mcp.transport",
                        "stdio" if "stdio" in str(read_stream).lower() else "unknown",
                    )
                    try:
            ...
            async def traced_handle_request(
                ...
                **kwargs: Any,
                ...
                with tracer.start_as_current_span(
                    ...
                    try:
                        result = await original_handle_request(
                            self, message, request, *args, **kwargs
                        )
                        ...
                        try:
                            if result is not None:
                                if hasattr(result, "model_dump_json"):
                                    span.set_attribute(
                                        "mcp.message.result", result.model_dump_json()
                                    )
    ...
    try:
        ...
        if hasattr(LowLevelServer, "_handle_message"):
            logger.debug("Instrumenting LowLevelServer._handle_message")
